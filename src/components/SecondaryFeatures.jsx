      ...
      {features.map((feature) => (
        <div key={feature.summary}>
          ...
          <div className="relative mt-10 pb-10">
            ...
            <div className="relative w-full max-w-full pl-4 overflow-hidden rounded-xl bg-slate-50 shadow-xl shadow-blue-900/20 sm:pl-6">
              <Image
          ...
          <TabPanels className="relative mt-20 overflow-hidden rounded-4xl bg-slate-200 px-14 py-16 xl:px-16">
            <div className="-mx-5 flex">
              {features.map((feature, featureIndex) => (
                ...
                >
                  <div className="relative w-[52.25rem] max-w-full pl-4 overflow-hidden rounded-xl bg-white shadow-lg ring-1 shadow-slate-900/5 ring-slate-500/10 sm:pl-6 lg:pl-8">
                    <Image
                      className="w-full h-auto object-contain max-w-[100vw]"
                      src={feature.image}
                      alt=""
